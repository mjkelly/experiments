...
flags.DEFINE_string('hostname', HOSTNAME,
                    'Name of this host, used to determine names of backends')
flags.DEFINE_string(
    'backend_host', HOSTNAME,
    'Hostname to use as backend; this is how haproxy will reach the docker containers'
)
